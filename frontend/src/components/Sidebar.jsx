  ...
  return (
    <div className='p-2 border-r border-r-white flex flex-col justify-between w-64 min-h-screen position-sticky top-0'>
      <div className='p-2 space-y-2'>
        ...
        <NavLink to="/likedVideos" className={({ isActive }) => isActive ? "bg-[#ae7aff] text-black block" : ""}><SidebarItem icon={faThumbsUp} name="Liked Videos" /></NavLink>
        <NavLink to="/history" className={({ isActive }) => isActive ? "bg-[#ae7aff] text-black block" : ""}><SidebarItem icon={faHistory} name="History" /></NavLink>
